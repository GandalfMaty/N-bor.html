...
<header>
  ...
  <p>Vyplň formulář pravdivě a pečlivě.</p>
</header>
...
<div class="box">
<h2>📖 Otázky na pravidla</h2>

<label>1. Co znamená RDM?</label>
<textarea name="Otázka 1"></textarea>
<label>2. Co znamená VDM?</label>
...
<label>6. Je povolené cheatování?</label>
<textarea name="Otázka 6"></textarea>
<label>7. Můžeš trollit ostatní hráče?</label>
<textarea name="Otázka 7"></textarea>
<label>8. Musíš respektovat admina?</label>
<textarea name="Otázka 8"></textarea>
<label>9. Co je Combat Logging?</label>
<textarea name="Otázka 9"></textarea>
<label>10. Co znamená NLR?</label>
<textarea name="Otázka 10"></textarea>
<label>11. Můžeš používat bugy?</label>
<textarea name="Otázka 11"></textarea>
<label>12. Je reklama na jiné servery povolena?</label>
<textarea name="Otázka 12"></textarea>
<label>13. Musíš používat realistické RP jméno?</label>
<textarea name="Otázka 13"></textarea>
<label>14. Můžeš zabít hráče bez RP důvodu?</label>
<textarea name="Otázka 14"></textarea>
<label>15. Co je hlavní pravidlo serveru?</label>
<textarea name="Otázka 15"></textarea>
</div>

<button type="submit">✅ Uložit a odeslat</button>

<p class="notice">
Náborový tým ti za chvíli zkontroluje odpovědi.
</p>
